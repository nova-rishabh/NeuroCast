...
export const api = {
  c1Predict: (text) => axios.post(`${BASE}/challenge1/predict`, { text }),
  c1Batch: (file) => {
  ...
  c3Predict: (text) => axios.post(`${BASE}/challenge3/predict`, { text }),
  c3Batch: (file) => {
  ...
  downloadAll: () => axios.get(`${BASE}/download/all`, { responseType: 'blob' }),
